...
function Services() {
  ...
  //  </div>
      ...
      // <div className='second-div'>
            ...
            <h1 className='ltext'> <b>AQUA</b> </h1>
            </div>

             <div className='link'> <button>www.AquaFoods.com</button> </div>
             </div>
            ...
            <div className='text'> <h1>HELLO WE ARE <span> AQUA</span></h1>
            <div className='line'></div> 
            <div className='para-text'><p> Our services to your satisfaction is our priority. <br/> choose us and get the best.  </p></div>
            </div>
            </div>
            ...
            <div className='title'> 
            <h2>OUR <span className='service'>SERVICE</span> </h2> 
            </div>
          ...
          <div className='right-side2'>
            ...
            <h6 className='b'> Projects <br/> Delivered </h6>
